...
select * from 
dbc.tables where creatorname='uff597';

proc sql;
connect to teradata as TD(mode=teradata server=oneview user=CN_SPAR
 password=CNSPAR23);
exec
(
delete from table
...
/* grant permissions */
grant all on ud155.PUBLIC_SECT_SALARY to u62262;/* Tanner's user */
