...
select earned_month as Year_Month &group_selec, 
...
select put(entered_date,yymmn6.0) as Year_Month &group_selec, 
...
select put(CR_LOSS_DATE,yymmn6.0) as Year_Month, 
...
put(cr_transaction_date,yymmn6.0)="&claims_as_of_date")*reserve) as gross_incurred format=12.0,
